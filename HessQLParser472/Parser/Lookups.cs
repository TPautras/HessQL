...
namespace HessQLParser.Parser
{
    ...
    {
        public static readonly Dictionary<Token.TokenTypes, BindingPower> BpLookup = new Dictionary<Token.TokenTypes, BindingPower>();
        public static readonly Dictionary<Token.TokenTypes, NudHandler> NudLookup = new Dictionary<Token.TokenTypes, NudHandler>();
        public static readonly Dictionary<Token.TokenTypes, LedHandler> LedLookup = new Dictionary<Token.TokenTypes, LedHandler>();
        public static readonly Dictionary<Token.TokenTypes, StmtHandler> StmtLookup = new Dictionary<Token.TokenTypes, StmtHandler>();
